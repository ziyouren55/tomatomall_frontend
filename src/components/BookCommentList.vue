...
export default {
  ...
  methods: {
    async loadReviews() {
      this.loading = true;
      try {
        const response = await bookReviewService.getBookComments(this.productId);
    ...
    async submitReview() {
      ...
      try {
        await bookReviewService.addBookComment(this.productId, this.newReview);
    ...
    async deleteReview(reviewId) {
      ...
      try {
        await bookReviewService.deleteBookComment(reviewId);
    ...
    async addComment(reviewId) {
      ...
      try {
        ...
        await bookReviewService.addBookComment(this.productId, commentData);
